                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="left" class="esd-block-text es-p20">
                                                    <h3 style="font-family: 'source sans pro', 'helvetica neue', helvetica, arial, sans-serif; font-size: 35px;">Xin chào, ${user?.name}</h3>
                                                    <p><br></p>
                                                    <p style="font-family: 'source sans pro', 'helvetica neue', helvetica, arial, sans-serif;">Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu của bạn. Nhấp vào nút bên dưới để thực hiện việc đặt lại mật khẩu:
                                            ...
                                            <tr>
                                                <td align="center" class="esd-block-button">
                                                  <span class="msohide es-button-border" style="display: block; background: #436e67;"><a href="${resetLink}" class="es-button msohide" target="_blank" style="padding-left: 5px; padding-right: 5px; display: block; background: #436e67; font-family: &quot;source sans pro&quot;, &quot;helvetica neue&quot;, helvetica, arial, sans-serif; font-weight: bold;">Đặt lại mật khẩu</a></span>
